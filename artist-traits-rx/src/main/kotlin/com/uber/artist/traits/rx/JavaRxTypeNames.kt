...
class JavaRxTypeNames {
  class Rx {
    companion object {
      ...
      // RxBinding
      val RecyclerViewScrollEvent = ClassName.get("com.jakewharton.rxbinding3.support.v7.widget", "RecyclerViewScrollEvent")
      ...
      val RxNestedScrollView = ClassName.get("com.jakewharton.rxbinding3.support.v4.widget", "RxNestedScrollView")
      val RxRecyclerView = ClassName.get("com.jakewharton.rxbinding3.support.v7.widget", "RxRecyclerView")
      val RxSearchView = ClassName.get("com.jakewharton.rxbinding3.support.v7.widget", "RxSearchView")
      ...
      val RxSwipeRefreshLayout = ClassName.get("com.jakewharton.rxbinding3.support.v4.widget", "RxSwipeRefreshLayout")
      val RxTabLayout = ClassName.get("com.jakewharton.rxbinding3.support.design.widget", "RxTabLayout")
      val RxTextView = ClassName.get("com.jakewharton.rxbinding3.widget", "RxTextView")
      val RxToolbar = ClassName.get("com.jakewharton.rxbinding3.support.v7.widget", "RxToolbar")
      val RxViewPager = ClassName.get("com.jakewharton.rxbinding3.support.v4.view", "RxViewPager")
      ...
      val SearchViewQueryTextEvent = ClassName.get("com.jakewharton.rxbinding3.support.v7.widget", "SearchViewQueryTextEvent")
