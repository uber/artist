...
class KotlinRxTypeNames {
  class Rx {
    companion object {
      ...
      // RxBinding
      val RecyclerViewScrollEvent = ClassName("com.jakewharton.rxbinding3.support.v7.widget", "RecyclerViewScrollEvent")
      ...
      val RxNestedScrollView = ClassName("com.jakewharton.rxbinding3.support.v4.widget", "RxNestedScrollView")
      val RxRecyclerView = ClassName("com.jakewharton.rxbinding3.support.v7.widget", "RxRecyclerView")
      val RxSearchView = ClassName("com.jakewharton.rxbinding3.support.v7.widget", "RxSearchView")
      ...
      val RxSwipeRefreshLayout = ClassName("com.jakewharton.rxbinding3.support.v4.widget", "RxSwipeRefreshLayout")
      val RxTabLayout = ClassName("com.jakewharton.rxbinding3.support.design.widget", "RxTabLayout")
      val RxTextView = ClassName("com.jakewharton.rxbinding3.widget", "RxTextView")
      val RxToolbar = ClassName("com.jakewharton.rxbinding3.support.v7.widget", "RxToolbar")
      val RxViewPager = ClassName("com.jakewharton.rxbinding3.support.v4.view", "RxViewPager")
      ...
      val SearchViewQueryTextEvent = ClassName("com.jakewharton.rxbinding3.support.v7.widget", "SearchViewQueryTextEvent")
