...
```gradle
classpath 'com.uber.artist:artist:0.2.2'
```
...
```gradle
classpath 'com.uber.artist:artist-api:0.2.2'
```
...
```gradle
classpath 'com.uber.artist:artist-traits:0.2.2'
```
...
```gradle
classpath 'com.uber.artist:artist-traits-rx:0.2.2'
```
